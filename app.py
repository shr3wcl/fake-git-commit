...
def fake_commit(username, email, message="Fake commit", from_date="2021-01-01", to_date="2021-12-31", time_commit="12:00:00", is_random=False):
    repo = check_repo()
    fake = faker.Faker()
    ...
    while fromdate < todate:
        for _ in range(random.randint(1, 10)): 
            ...
            with open(file_name, 'w') as f:
                # Random text + random number + random date + random time + random text
